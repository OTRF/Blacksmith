function New-AzADManagedIdentity {
    <#
    .SYNOPSIS
    ...
    .DESCRIPTION
    New-AzADManagedIdentity is a simple PowerShell wrapper around the Azure CLI "az identity" command to create a user assigned managed identity.
