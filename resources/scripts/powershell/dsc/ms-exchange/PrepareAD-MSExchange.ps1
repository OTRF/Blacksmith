...
{ 
   ...
   ( 
    ...
    # https://docs.microsoft.com/en-us/exchange/new-features/build-numbers-and-release-dates?view=exchserver-2019&WT.mc_id=M365-MVP-5003086
    ...
    # https://learn.microsoft.com/en-us/exchange/plan-and-deploy/prepare-ad-and-domains?view=exchserver-2019#exchange-2019-active-directory-versions
    ...
    $MXDirVersions = Switch ($MXSRelease) {
        'MXS2019-x64-CU12-KB5011156' { @{SchemaVersion = 17003; OrganizationVersion = 16760; DomainVersion = 13243} }
        'MXS2019-x64-CU11-KB5005334' { @{SchemaVersion = 17003; OrganizationVersion = 16759; DomainVersion = 13242} }
    ...
    $MXSISOServerVersion = $MXSISOFile.ServerVersion
    ...
    Node localhost
    {
        ...
        xScript PrepSchema
        {
            SetScript =
            {
                ...
                if (($using:MXSISOServerVersion -eq 2016 -and $using:MXSISOCU -ge 22) -or ($using:MXSISOServerVersion -eq 2019 -and $using:MXSISOCU -ge 11)) {
                    <#
